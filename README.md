...
python -m text2sql.schema.summary.generate_schema_summary --mode product_sales
...
python -m text2sql.schema.summary.generate_schema_summary --mode product_sales
python -m text2sql.schema.summary.generate_schema_summary --mode mock_relational

python -m text2sql.schema.entities.build_schema_entities --mode product_sales
python -m text2sql.schema.entities.build_schema_entities --mode mock_relational

python -m text2sql.schema.retrieval.build_schema_pgvector_index --mode product_sales --rebuild
python -m text2sql.schema.retrieval.build_schema_pgvector_index --mode mock_relational --rebuild
